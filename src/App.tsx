  ...
  return (
    <div className="relative min-h-screen w-full bg-[#030303] text-gray-100 flex flex-col overflow-hidden">
      ...
      >
        ...
        <nav className="mx-auto flex h-full max-w-[2560px] items-center justify-between responsive-px">
          ...
          <div className="hidden min-[1200px]:flex items-center justify-center flex-1 mx-8">
            <div className="flex max-w-full flex-nowrap items-center justify-center gap-4">
              ...
              >
                <button 
                  type="button" 
                  className={`header-btn-algorithm inline-flex shrink-0 items-center rounded-[2px] px-3 py-1 text-[14px] font-semibold leading-5 whitespace-nowrap transition-colors touch-manipulation focus-visible:outline-none cursor-pointer ${
                ...
                <div className={`dropdown-panel-algorithm fixed inset-x-0 top-14 left-0 right-0 w-full bg-transparent backdrop-blur-xl border-b border-white/10 shadow-2xl transition-all duration-200 z-50 ${activeDropdown === 'algorithm' ? 'opacity-100 pointer-events-auto translate-y-0' : 'opacity-0 pointer-events-none -translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto'}`}>
                  <div className="mx-auto max-w-[2560px] responsive-px pb-10 pt-6">
                    {/* Grid of links */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full text-left">
                      ...
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">AWE 3.5 AI世界引擎</div>
                      ...
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">WIYH 数据集</div>
                      ...
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">SenseHub</div>
              ...
              >
                <button 
                  type="button" 
                  className={`header-btn-ontology inline-flex shrink-0 items-center rounded-[2px] px-3 py-1 text-[14px] font-semibold leading-5 whitespace-nowrap transition-colors touch-manipulation focus-visible:outline-none cursor-pointer ${
                  ...
                  <div className="mx-auto max-w-[2560px] responsive-px pb-10 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 w-full text-left">
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">A系列机器人</div>
                      ...
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">T系列机器人</div>
                      ...
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">Tars DexHand</div>
                      ...
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">Tars Drive 灵巧关节</div>
              ...
              >
                <button 
                  type="button" 
                  className={`header-btn-application inline-flex shrink-0 items-center rounded-[2px] px-3 py-1 text-[14px] font-semibold leading-5 whitespace-nowrap transition-colors touch-manipulation focus-visible:outline-none cursor-pointer ${
                  ...
                  <div className="mx-auto max-w-[2560px] responsive-px pb-10 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full text-left">
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">AWR</div>
              ...
              >
                <button type="button" className="inline-flex shrink-0 items-center rounded-[2px] px-3 py-1 text-[14px] font-semibold leading-5 whitespace-nowrap transition-colors touch-manipulation focus-visible:outline-none text-white hover:text-[#0050b5] cursor-pointer">
                  <span>关于我们</span>
                </button>
                {/* Mega Menu Panel - Frosted Glassmorphism */}
                  ...
                  <div className="mx-auto max-w-[2560px] responsive-px pb-10 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full text-left">
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">公司介绍</div>
                      ...
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">联系我们</div>
                      ...
                      <a 
                        ...
                        className="group/item block p-4 rounded-xl border border-transparent hover:border-white/5 hover:bg-white/5 transition-all duration-200"
                      >
                        <div className="font-semibold text-[14px] text-white group-hover/item:text-[#0050b5] transition-colors">加入我们</div>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex shrink-0 items-center rounded-[2px] px-3 py-1 text-[14px] font-semibold leading-5 whitespace-nowrap transition-colors touch-manipulation focus-visible:outline-none text-white hover:text-[#0050b5] cursor-pointer"
                onMouseEnter={() => { if (activeDropdown) setActiveDropdown(null); }}
              >
                新闻中心
              </a>
